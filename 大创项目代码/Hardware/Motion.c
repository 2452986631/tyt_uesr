...
int8_t Speeda,Speedb;
int8_t Speed1,Speed2,Speed3,Speed4;
...
void Turn_left(int8_t Speed1,int8_t Speed2,int8_t Speed3,int8_t Speed4)//参数大于0
{
...
void Trun_right(int8_t Speed1,int8_t Speed2,int8_t Speed3,int8_t Speed4)//参数大于0
{
	Motor_SetSpeed_a(Speed1);
	Motor_SetSpeed_b(Speed2);
  Motor_SetSpeed_c(Speed3);
